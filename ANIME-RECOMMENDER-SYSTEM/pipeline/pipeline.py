# creating db as retriver (prediction pipeline)

#create AnimeRecommendationPipeline class that will tie everything together. It will use the VectorStoreBuilder to build and load the vector store, and the Recommender to generate recommendations based on user query.
...
class AnimeRecommendationPipeline:
    def __init__(self,persist_dir="chroma_db"):
        try:
            ...
            #passing data to recommender class to generate recommendation using  chain
    ...
    def recommend(self,query:str) -> str:
        try:
            ...
            recommendation = self.recommender.generate_recommendations(query)
